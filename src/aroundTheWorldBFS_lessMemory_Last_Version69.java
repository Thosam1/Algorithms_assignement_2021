...
public class aroundTheWorldBFS_lessMemory_Last_Version69 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> airCities = new ArrayList<Integer>(); // could sort them so we find the city in logn time eg: binary search
...
//                                    System.out.println("we are here in the loop, the actual neighbor " + neigh);
...
//                                                System.out.println("we are adding neighbour : " + neigh);
                            ...
                            for (Integer neigh : graph.list[removed]) {
                                if (visited[neigh] == false || neigh == t) {
//                            System.out.println("neighbour route being considered: " + neigh);
